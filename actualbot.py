...
async def openaccount(user):
    ...
    if str(user) in data:
        ...
        data[str(user)]['stock'] = {'aapl': [0, 0],'goog': [0, 0],'nflx': [0, 0],'fb': [0, 0],'amzn': [0, 0],'tsla': [0, 0],'baba': [0, 0],'nvda': [0, 0],'msft': [0, 0],'twtr': [0, 0],'gme': [0, 0],'btc-usd': [0, 0],'bch-usd': [0, 0],'ltc-usd)': [0, 0],'eth-usd': [0, 0],'bnb-usd': [0, 0],'link-usd': [0, 0],'doge-usd': [0, 0]}
